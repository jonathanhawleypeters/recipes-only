const recipe = {
  title: "Mariano's Beef & Barley Soup",
  description: "A hearty and comforting soup with beef, barley, and vegetables, finished with a flavorful condiment",
  ingredients: {
    serves: 4,
    items: [
      "Celery, chopped (generous amount)",
      "Pre-cooked and rinsed barley",
      "Beef broth",
      "Chicken broth",
      "Carrots, peeled and diced",
      "Oil",
      "Onion, coarsely chopped",
      "Stir-fry beef or sausage",
      "Garlic cloves",
      "Fresh parsley",
      "White wine (optional)",
      "Tomato sauce or paste (optional)",
  ...
  source: {
    type: "video",
    text: "Mariano's Beef & Barley Soup - https://youtu.be/U2wl9XPRa8w?si=IJLge8n8O97rjhMZ"
  },
  img: {
    "src": "/images/mariano-beef-barley-soup.webp",
