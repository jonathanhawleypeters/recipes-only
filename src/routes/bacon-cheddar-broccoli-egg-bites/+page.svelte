<svelte:head>
  <title>Bacon, cheddar, broccoli egg bites</title>
  <meta name="description" content="A high protein, low calorie bacon, cheddar, broccoli egg bite recipe" />
</svelte:head>
...
<div>
  ...
  <enhanced:img
  class="hero-image"
  src="/static/images/bacon-cheddar-broccoli-egg-bites.webp?h=640;320;160&w=640;320;160${img.aspectRatio ? '' : '&aspect=1:1'}"
